<template>
  <div class="tabs-view" :class="{ compact: isLayoutCompact }">
    <a-tabs
...
<script setup lang="ts">
  ...
  const activeKey = computed(() => tabsViewStore.getCurrentTab?.fullPath || '/dashboard/welcome')

  // console.log(activeKey.value, tabsViewStore.getTabsList, tabsViewStore.getCurrentTab)
  ...
  /** 是否紧凑布局 */
  const isLayoutCompact = computed(() => layoutStore.getSize === 'compact')
